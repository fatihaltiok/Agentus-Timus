...
@tool(
    name="read_text_from_screen",
    description="Erfasst den Bildschirm und extrahiert Text mit der zentralen, GPU-beschleunigten OCREngine.",
    parameters=[
        P("with_boxes", "boolean", "Wenn True, gibt auch die Bounding-Boxen für jeden Textblock zurück.", required=False, default=False),
    ],
